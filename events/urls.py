...
from .views import (
    HomeView,
    EventListView, EventDetailView, EventCreateView, EventUpdateView, DashboardView, EventDeleteView
)
...
router.register(r'events', EventViewSet, basename='event')  # само 'events' тук, без 'api/'
